...
function page_header($config){
  $html="";
  $html.="<header class=\"py-3 mb-4 border-bottom no-print\">";
 ...
 function form_wrap_open($config=[]){
  $config["title"]=isset($config["title"])?$config["title"]:"&nbsp;"; 
   $html="<div class='card' style='padding:10px;margin-top:10px;background:#fff;border:2px groove #e73374;'>";
 ...
 function table_wrap_open(){
    ...
    $html="<div style='padding:10px;margin-top:10px;background:#fff;border:2px groove #e73374;'>";
