...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		$result=$db->query("SELECT u.id,u.username,r.name role,u.password,u.email,u.full_name,u.created_at,u.photo,u.verify_code,u.inactive,u.mobile,u.updated_at FROM {$tx}users u,{$tx}roles r where r.id=u.role_id limit $top,$perpage");

		$html="<div class='mb-3'><a class=\"btn btn-success\" href=\"create-user\">New User</a></div>";
		$html.="<table class='table'>";
		if($action){
			$html.="<tr><th>Id</th><th>Username</th><th>Role</th><th>Password</th><th>Email</th><th>Mobile</th><th>Photo</th><th>Action</th></tr>";
		}else{
			$html.="<tr><th>Id</th><th>Username</th><th>Role</th><th>Password</th><th>Email</th><th>Mobile</th><th>Photo</th></tr>";
		}
		while($user=$result->fetch_object()){
			$action_buttons = "";
			if($action){
			...
			$html.="<tr><td>$user->id</td><td>$user->username</td><td>$user->role</td><td>$user->password</td><td>$user->email</td><td>$user->mobile</td><td><img src=\"img/$user->photo\" width=\"100\" /></td>$action_buttons</tr>";
		}
		$html.="</table>";
