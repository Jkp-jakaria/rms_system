...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		$result=$db->query("SELECT p.id,p.name,p.grade,d.name department FROM {$tx}positions p,{$tx}departments d where d.id=p.department_id limit $top,$perpage");

		$html="<div class='mb-3'><a class=\"btn btn-success\" href=\"create-position\">New Position</a></div>";
