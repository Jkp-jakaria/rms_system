        ...
        <div class="invoice p-3 mb-3">
          ...
          <div class="row no-print">
            <div class="col-12">
              ...
              <button type="button" id="btnCheckoutOrder" class="btn btn-success float-right"><i class="fa fa-credit-card-alt"></i> Checkout Order </button>
            </div>
          </div>
        </div>
        <!-- /.invoice -->
...
<script>
  $(function() {
    ...
    $("#btnCheckoutOrder").on("click", function() {
