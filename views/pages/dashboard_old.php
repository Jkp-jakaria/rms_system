    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
              <div class="card d-card">
                <div class="card-header pt-2">
                  <div class="d-icon icon-lg icon-shape bg-gradient-dark shadow-dark text-center border-radius-xl mt-n4 position-absolute">
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
              <div class="card d-card">
                <div class="card-header pt-2">
                  <div class="icon icon-lg icon-shape bg-gradient-defult shadow-primary text-center border-radius-xl mt-n4 position-absolute">
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            <!-- small box -->
            <div class="small-box bg-white elevation-3">
            <div class="icon">
